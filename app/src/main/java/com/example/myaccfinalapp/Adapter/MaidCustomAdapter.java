...
public class MaidCustomAdapter extends RecyclerView.Adapter<MaidCustomAdapter.ImageViewHolder> {
    private Context mContext;
    private List<Upload> mUploads;
    private OnItemClickListener mListener;

    public MaidCustomAdapter(Context mContext, List<Upload> mUploads) {
    ...
    public void onBindViewHolder(ImageViewHolder holder, int position) {
        ...
        holder.mTvEmail.setText(uploadCurrent.getEmail());
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnCreateContextMenuListener, MenuItem.OnMenuItemClickListener {
        ...
        TextView mTvName, mTvPhone, mTvEmail;
        ImageView imageView;
